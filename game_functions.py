...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, audio):
    """响应按键和鼠标事件"""
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, ai_settings, screen, stats, sb, ship, aliens, bullets, audio)
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets, audio):
    # 检查是否有子弹击中了外星人
    # 如果是这样，就删除相应的子弹和外星人
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets, audio):
    # 更新子弹的位置
    bullets.update()
    # 删除已消失的子弹
    ...
    check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets, audio)
